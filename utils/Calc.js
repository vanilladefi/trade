...
/*
  ...
  ------------------------------------------ */
export const calcRand = (min, max, ease) => {
  if (max === undefined) {
    max = min
    min = 0
  }
...
/*
  ...
  ------------------------------------------ */
export const calcMap = (val, inputMin, inputMax, outputMin, outputMax) => {
  return (
...
/*
  ...
  ------------------------------------------ */
export const calcClamp = (val, min, max) => {
...
/*
  ...
  ------------------------------------------ */
export const calcRoundToUpperInterval = (value, interval) => {
  if (value % interval === 0) {
    value += 0.0001
  }
...
/*
  ...
  ------------------------------------------ */
export const calcRoundToLowerInterval = (value, interval) => {
  if (value % interval === 0) {
    value -= 0.0001
  }
...
/*
  ...
  ------------------------------------------ */
export const calcRoundToNearestInterval = (value, interval) => {
...
/*
  ...
  | in 3D space.
  ------------------------------------------ */
export const calcIntersectSphere = (a, b) => {
...
/*
  ...
  ------------------------------------------ */
export const calcGetIndexFromCoords = (x, y, w) => {
  return x + y * w
}
...
/*
  ...
  ------------------------------------------ */
export const calcGetCoordsFromIndex = (i, w) => {
  return {
    x: i % w,
    y: Math.floor(i / w),
  }
