...
No. The entire initial supply of VNL was created via profit mining by the community. 

## Who created Vanilla?

Vanilla was developed by [Equilibrium](https://equilibrium.co/) and the smart contracts were deployed by an anonymous community member to the Ethereum blockchain. 
...
The VanillaDAO is a community controlled 4-out-of-7 ethereum multi-sig wallet, which hosts the VanillaDAO treasury and is used for deploying some parts of the Vanilla protocol. Equilibrium controls 3 of the 7 signers and the remaining 4 signers are the largest VNL holders from the community. 
