...
While you can trade almost anything through Vanilla, only tokens with enough liquidity are eligible for profit mining to protect against price manipulation attacks. Liquidity is calculated from WETH reserves on Uniswap and the more liquidity there is, the higher the rewards are. You can see which tokens are eligible for profit mining on the Trade page.
...
## What is the Value-Protection Coefficient and why Vanilla uses it
...
## What is the Holding/Trading Ratio (Squared) and why Vanilla uses it
