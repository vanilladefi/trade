...
The secondary scope of the bug bounty program is for vulnerabilities in the Vanilla Interface code that could likely result in the unauthorized exploitation of users of Vanilla Interface hosted at vanilladefi.com/trade.
